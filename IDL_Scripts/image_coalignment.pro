function image_coalignment, directory
  ...
  CMER=183.44300
  BANG=7.1530000
  output = '/Users/crura/Desktop/Research/Magnetic_Field/Forward_MLSO_Projection.fits'
  data = dens_2d
...
;  WRITE_PSI_IMAGE_AS_FITS,output,data,x_array,y_array,DATE,CMER,BANG,/GetCoords;,ObsDistanceAU=1
  ...
  restore,'/Users/crura/Bx_2d_MLSO.sav',/v
  bx_central = bx_2d
  output_bx_central = '/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bx_Central_MLSO_Projection.fits'
  ...
  restore,'/Users/crura/By_2d_MLSO.sav',/v
  by_central = by_2d
  output_by_central = '/Users/crura/Desktop/Research/Magnetic_Field/Forward_By_Central_MLSO_Projection.fits'
  ...
  restore,'/Users/crura/Bz_2d_MLSO.sav',/v
  bz_central = bz_2d
  output_bz_central = '/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bz_Central_MLSO_Projection.fits'
  ...
  bx_los_1d = read_csv('/Users/crura/Desktop/Research/Magnetic_Field/MLSO_Rotated_Integrated_LOS_Bx.csv')
  bx_los_2d = reform(bx_los_1d.field1,256,256)
  output_bx_los = '/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bx_LOS_MLSO_Projection.fits'
  WRITE_PSI_IMAGE_AS_FITS,output_bx_los,bx_los_2d,x_array,y_array,DATE,CMER,BANG,/GetCoords;,ObsDistanceAU=1
  
  
  ; Construct and write fits image for PSI Bx LOS field
  by_los_1d = read_csv('/Users/crura/Desktop/Research/Magnetic_Field/MLSO_Rotated_Integrated_LOS_By.csv')
  by_los_2d = reform(by_los_1d.field1,256,256)
  output_by_los = '/Users/crura/Desktop/Research/Magnetic_Field/Forward_By_LOS_MLSO_Projection.fits'
  WRITE_PSI_IMAGE_AS_FITS,output_by_los,by_los_2d,x_array,y_array,DATE,CMER,BANG,/GetCoords;,ObsDistanceAU=1
  
  
  ; Construct and write fits image for PSI Bx LOS field
  bz_los_1d = read_csv('/Users/crura/Desktop/Research/Magnetic_Field/MLSO_Rotated_Integrated_LOS_Bz.csv')
  bz_los_2d = reform(bz_los_1d.field1,256,256)
  output_bz_los = '/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bz_LOS_MLSO_Projection.fits'
  ...
  mlso_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Coalign/20170829_200801_kcor_l2_avg.fts')
  mlso_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Coalign/20170829_200801_kcor_l2_avg.fts')
  wcs_mlso = fitshead2wcs( mlso_head )
  coord = wcs_get_coord( wcs_mlso )
   

  ;psi_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_MLSO_Projection.fits')
  ;psi_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_MLSO_Projection.fits')

  ;wcs_psi = fitshead2wcs( psi_head )

  ;pixel = wcs_get_pixel( wcs_psi, coord)
  ;new_psi = reform( interpolate( psi_im, pixel[0,*,*], pixel[1,*,*] ))
  ;spath = '/Users/crura/Desktop/Research/Magnetic_Field/FORWARD_MLSO_Rotated_Data/PSI_MLSO_Coalignment' + '.csv'
  ...
  psi_bx_central_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bx_Central_MLSO_Projection.fits')
  psi_bx_central_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bx_Central_MLSO_Projection.fits')
  ...
  spath_bx_central = '/Users/crura/Desktop/Research/Magnetic_Field/FORWARD_MLSO_Rotated_Data/PSI_Bx_Central_MLSO_Coalignment' + '.csv'
  write_csv,spath_bx_central,new_psi_bx_central
  
  
  ; Coalign PSI Forward B_y Central 2d Plane of Sky cut with MLSO image
  psi_by_central_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_By_Central_MLSO_Projection.fits')
  psi_by_central_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_By_Central_MLSO_Projection.fits')
  ...
  spath_by_central = '/Users/crura/Desktop/Research/Magnetic_Field/FORWARD_MLSO_Rotated_Data/PSI_By_Central_MLSO_Coalignment' + '.csv'
  write_csv,spath_by_central,new_psi_by_central
  
  
  ; Coalign PSI Forward B_z Central 2d Plane of Sky cut with MLSO image
  psi_bz_central_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bz_Central_MLSO_Projection.fits')
  psi_bz_central_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bz_Central_MLSO_Projection.fits')
  ...
  spath_bz_central = '/Users/crura/Desktop/Research/Magnetic_Field/FORWARD_MLSO_Rotated_Data/PSI_Bz_Central_MLSO_Coalignment' + '.csv'
  write_csv,spath_bz_central,new_psi_bz_central
  
  
  ; Coalign PSI Forward B_x LOS Integrated field with MLSO image
  psi_bx_los_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bx_LOS_MLSO_Projection.fits')
  psi_bx_los_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bx_LOS_MLSO_Projection.fits')
  ...
  spath_bx_los = '/Users/crura/Desktop/Research/Magnetic_Field/FORWARD_MLSO_Rotated_Data/PSI_Bx_LOS_MLSO_Coalignment' + '.csv'
  write_csv,spath_bx_los,new_psi_bx_los
  
  
  ; Coalign PSI Forward B_y LOS Integrated field with MLSO image
  psi_by_los_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_By_LOS_MLSO_Projection.fits')
  psi_by_los_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_By_LOS_MLSO_Projection.fits')
  ...
  spath_by_los = '/Users/crura/Desktop/Research/Magnetic_Field/FORWARD_MLSO_Rotated_Data/PSI_By_LOS_MLSO_Coalignment' + '.csv'
  write_csv,spath_by_los,new_psi_by_los
  
  
  ; Coalign PSI Forward B_z LOS Integrated field with MLSO image
  psi_bz_los_im = readfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bz_LOS_MLSO_Projection.fits')
  psi_bz_los_head = headfits('/Users/crura/Desktop/Research/Magnetic_Field/Forward_Bz_LOS_MLSO_Projection.fits')
  ...
  spath_bz_los = '/Users/crura/Desktop/Research/Magnetic_Field/FORWARD_MLSO_Rotated_Data/PSI_Bz_LOS_MLSO_Coalignment' + '.csv'
  ...
  save,bx_central_coaligned,by_central_coaligned,bz_central_coaligned,filename='/Users/crura/Desktop/Research/Magnetic_Field/Central_B_Field_MLSO_Coaligned.sav'
  save,bx_los_coaligned,by_los_coaligned,bz_los_coaligned,filename='/Users/crura/Desktop/Research/Magnetic_Field/LOS_B_Field_MLSO_Coaligned.sav'
