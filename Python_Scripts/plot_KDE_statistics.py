...
# plt.text(20,0.045,"MLSO average difference: " + str(np.round(np.average(err_mlso_central_deg),5)))
# plt.text(20,0.04,"FORWARD average difference: " + str(np.round(np.average(err_forward_central_deg),5)))
...
plt.xlim(0,90)
plt.ylim(0,0.07)
# plt.text(20,0.045,"MLSO average difference: " + str(np.round(np.average(err_mlso_los_deg),5)))
# plt.text(20,0.04,"FORWARD average difference: " + str(np.round(np.average(err_forward_los_deg),5)))
# plt.text(20,0.035,"Random average difference: " + str(np.round(np.average(err_random_deg),5)))
plt.legend()
...
ax[0].set_xlabel('Angular Difference')
...
ax[1].set_xlabel('Angular Difference')
...
print("MLSO average difference: " + str(np.round(np.average(err_mlso_central_deg),5)))
print("FORWARD average difference: " + str(np.round(np.average(err_forward_central_deg),5)))
print("Random average difference: " + str(np.round(np.average(err_random_deg),5)))

print("MLSO LOS average difference: " + str(np.round(np.average(err_mlso_los_deg),5)))
print("FORWARD LOS average difference: " + str(np.round(np.average(err_forward_los_deg),5)))
print("Random average difference: " + str(np.round(np.average(err_random_deg),5)))
print("")
...
print("COR-1 Central average difference: " + str(np.round(np.average(err_cor1_central_deg),5)))
print("FORWARD Central average difference: " + str(np.round(np.average(err_forward_cor1_central_deg),5)))
print("Random average difference: " + str(np.round(np.average(err_random_deg),5)))

print("COR-1 Central median difference: " + str(np.round(np.median(err_cor1_central_deg),5)))
print("FORWARD Central median difference: " + str(np.round(np.median(err_forward_cor1_central_deg),5)))
print("Random average difference: " + str(np.round(np.median(err_random_deg),5)))
print("")
