function image_coalignment, directory
  ...
  mlso_im = readfits(git_repo + '/Data/MLSO/20170829_200801_kcor_l2_avg_2.fts')
  mlso_head = headfits(git_repo + '/Data/MLSO/20170829_200801_kcor_l2_avg_2.fts')
  ...
  save,bx_los_coaligned,by_los_coaligned,bz_los_coaligned,filename=git_repo + '/Output/LOS_B_Field_MLSO_Coaligned.sav'
